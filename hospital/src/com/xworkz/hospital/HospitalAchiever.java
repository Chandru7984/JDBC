...
public class HospitalAchiever {
	...
	public static void main(String[] args) {
		...
		HospitalDTO hospitalDTO1 = new HospitalDTO(1, "Jay Deva", "C N Manjunath", "Cardiac", 1972);
		HospitalDTO hospitalDTO2 = new HospitalDTO(2, "Abhaya", "Narayan", "General", 1980);
		HospitalDTO hospitalDTO3 = new HospitalDTO(3, "Jayamma", "Manjunath", "Cardiac", 1985);
		HospitalDTO hospitalDTO4 = new HospitalDTO(4, "Mannan", "Chandru", "Urology", 1968);
		HospitalDTO hospitalDTO5 = new HospitalDTO(5, "Ramakrishna", "Veeresh", "Cardiac", 1990);
		HospitalDTO hospitalDTO6 = new HospitalDTO(6, "Roshan", "Vijayanand", "General", 1986);
		HospitalDTO hospitalDTO7 = new HospitalDTO(7, "Rotary", "Vinay", "Heart", 1985);
		HospitalDTO hospitalDTO8 = new HospitalDTO(8, "Sahara", "Vishwanath", "Lever", 1987);
		HospitalDTO hospitalDTO9 = new HospitalDTO(9, "Scan Point", "Ravindranath", "Lungs", 1996);
		HospitalDTO hospitalDTO10 = new HospitalDTO(10, "Seetha", "Swathi Krishnamurthi", "General", 2000);
		HospitalDTO hospitalDTO11 = new HospitalDTO(11, "Sharada", "Sudarshan", "Kidney", 2001);
		HospitalDTO hospitalDTO12 = new HospitalDTO(12, "Shyam", "Venkatesh", "Body", 2016);
		HospitalDTO hospitalDTO13 = new HospitalDTO(13, "Sindhu", "Prajwal", "Cardiac", 2008);
		HospitalDTO hospitalDTO14 = new HospitalDTO(14, "Sir M V", "Veerabhadrappa", "Skin", 1998);
		HospitalDTO hospitalDTO15 = new HospitalDTO(15, "Sri Danamma", "Ranganna", "Bone", 1997);
		HospitalDTO hospitalDTO16 = new HospitalDTO(16, "Sri Devi", "Radhika", "Cardiac", 1999);
		HospitalDTO hospitalDTO17 = new HospitalDTO(17, "Sri Manjunatha", "Manjanna", "General", 2000);
		HospitalDTO hospitalDTO18 = new HospitalDTO(18, "Sri Dharma", "Chetan", "Heart", 1987);
		HospitalDTO hospitalDTO19 = new HospitalDTO(19, "Sri Nava Ratna", "Chandranna", "Surgery", 1983);
		HospitalDTO hospitalDTO20 = new HospitalDTO(20, "Sri Raghava", "Rajanna", "Eye", 1984);
		HospitalDTO hospitalDTO21 = new HospitalDTO(21, "Sri Ram", "Siddappa", "Nose", 1988);
		HospitalDTO hospitalDTO22 = new HospitalDTO(22, "Sri Ranga", "Manjappa", "Ear", 1999);
		HospitalDTO hospitalDTO23 = new HospitalDTO(23, "Sri Sai", "Omkarappa", "Mouth", 1969);
